...
function ajax(num) {
   ...
   $.ajax({
      ...
      <!-- ================================== content+photo+regDate ========================================== -->             
      		 ...
      		 tare += "<div class='item'>";
             tare += "<div id='mfeedContet" + i + "' align='center' style='padding: 0 30px;'>";
             ...
             var photo = data.saveFile;
               ...
               for(var k=0; k<saveFile.length; k++){
                  tare += "<img class='tarae_img' src='http://10.10.8.226:8888/sns/resources/images/FileRepo/"+saveFile[k]+"' style='margin: 15px; width: 100px; height: 100px;'>";
                 }
             }

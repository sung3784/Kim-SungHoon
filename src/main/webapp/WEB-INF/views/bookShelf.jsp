...
<!-- =============================================== Content ================================================ -->
   ...
   <div class="ui bottom attached padded context">
                     ...
                     <table align="center" style="text-align: center; table-layout: fixed;">
                        <tr>
                           <td>
                              ...
                              <img src="${bookShelf.thumbnail}" style="width: 85px; height: 100px;">
                                 <c:choose>
                                    <c:when test="${bookShelf.readYN eq 'Y'}">
                                       <img alt="읽었습니다." src="./resources/images/check.png" width="15px;">
                                    </c:when>
                                    <c:otherwise>
                                       <img alt="읽지 않았습니다." src="./resources/images/check-empty.png" width="15px;"> 
                                    </c:otherwise>
                                 </c:choose>
                              <br/>

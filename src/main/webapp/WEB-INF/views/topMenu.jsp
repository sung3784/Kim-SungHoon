...
<!-- ================================================= MENU ================================================= -->
   ...
   <div class="ui top attached inverted menu sticky fixed" style="background-color: #452e28; margin-top: 0px;">
...
<%--          <div class="right item">
   ...
   <div class="right item">
      ...
      <div class="menu" id="add">Bookadd</div>
      <div class="menu" id="library">Bookshelf</div>
      <div class="menu" id="ranking">Ranking</div>
      <div class="menu" id="dm">DM</div>
      <div class="menu" id="alarm">Alarm</div>
      <div class="menu" id="logout">Logout</div>
   </div>
   </div>
</div>

<!--       <div class="ui right attached menu">
         <a class="item"> 

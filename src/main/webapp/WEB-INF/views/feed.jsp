...
<head>
   ...
   <script src="./resources/assets/js/feed-skel.min.js"></script>
   <script src="./resources/assets/js/feed-util.js"></script>
   <script src="./resources/assets/js/feed-main.js"></script>
   ...
   <script type="text/javascript">
      ...
      function taraeMention(feedNum) {
         ...
         /* mention += "<div class='existed-inner ui padded segment' class='feedWrote'>"; */
         mention += "<h2 class='ui header left floated'>";
          
          if($("#userInfo").val()!=null) {
             mention += "<img class='ui avatar image'  src='http://10.10.8.226:8888/sns/resources/images/FileRepo/"+$("#userInfo").val()+"'/>";
          } else {
             mention += "<img class='ui avatar image'  src='http://localhost:8888/sns/resources/images/defaultAvatar.png'/> "; 
          }
          
          mention += "</h2>"
          mention += "<div class='ui left icon input fluid' style='margin-bottom: 15px;'>";
          ...
          mention += "<div id='img_wrap2' style='margin-top: 10px;'></div>";
          ...
          mention += "</div>";
          mention += "</div>";
          mention += "<div class='ui hidden divider'></div>";
          mention += "<div class='ui divider'></div>";
          /* mention += "</div>"; */
   ...
   <script type="text/javascript">
      ...
      function output(resp) {
          ...
          if(resp.user.saveFile != null) {
             mention += "<h3> <img class='ui circular image' style='width:70px; height:50px;float:left; ' src='http://10.10.8.226:8888/sns/resources/images/FileRepo/"+resp.user.saveFile+"' />";
          } else {
          ...
          mention +="<h2 class='ui header left floated'>"
          if($("#userInfo").val()!=null) {
             mention += "<img class='ui circular image'  src='http://10.10.8.226:8888/sns/resources/images/FileRepo/"+$("#userInfo").val()+"'/>";
          }else{
          ...
          function upcomigFeed(resp) {
             ...
             $.each(resp.feed,function(index,item){
               ...
               if(item.profilePic == null){
                  ...
                  mention += "<img class='ui avatar image' src='http://10.10.8.226:8888/sns/resources/images/FileRepo/"+item.profilePic+"'>";
               }
      ...
      //=================================== targetId ==========================
            ...
            mention += "<div class='feedTarget'>";
               ...
               var photo = item.saveFile;
                    ...
                    var saveFile = photo.split(",");
                    for(var k=0; k<saveFile.length; k++){
                       mention += "<img class='img_show_example' src='http://10.10.8.226:8888/sns/resources/images/FileRepo/"+saveFile[k]+"'>";
                      }
               };
...
<body>
   ...
   <!-- ================================================= MAIN ================================================= -->
   <section id="main" class="context" style="background-color: transparent;">
      <div class="inner">

         <!-- =============================================== FeedList =============================================== -->
      
         <div class="ui bottom attached padded context" id="main">
            <div class="ui main text container" style="padding: 30px 0;">
      
         <!-- ==================================== 밑에 피드 부분 시작은 글쓰기 부분부터 ====================================== -->      
               <c:if test="${nowPage ne 'feedSearch'}">
               <div class="feedWrite fluid" align="center">
                  <div class="ui padded segment">
                     <input type="hidden" id="follow" value="${follow}">
                        <c:if test="${sessionScope.saveFile != null}">
                           <img src="http://10.10.8.226:8888/sns/resources/images/FileRepo/${sessionScope.saveFile}" class="profile">
                           <b>${sessionScope.userId }</b>
                        </c:if>
                        <c:if test="${sessionScope.saveFile == null}">
                           <img src="http://localhost:8888/resources/images/defaultAvatar.png" class="profile">
                           <b>${sessionScope.userId }</b>
                        </c:if>
                        ...
                        <div class="ui list">
                           ...
                           <div class="item">
                              <div class="ui search">
                                 <div class="ui left icon input fluid">
                                    <input type="text" placeholder="Users" id="feed_spread_targetid" name="targetId">
         ...
         <!-- =============================================== userid ================================================== -->
                              ...
                              <div class="item">
                               <div class="feedUser">
                                  <c:if test="${feed.saveFile == null}">
                                    <img class="ui avatar image" src="http://localhost:8888/sns/resources/images/defaultAvatar.png">
                                  </c:if>
                                  <c:if test="${feed.saveFile != null }">
                                    <img class="ui avatar image" src="http://10.10.8.226:8888/sns/resources/images/FileRepo/${feed.saveFile }">
                                  </c:if>
                           ...
                           <div class="item">
                               ...
                               <input type="hidden" id="originalFeedNum${num.index }" value="${feed.originalFeedNum }">
                                  ...
                                  <c:if test="${feed.photoYN eq 'Y'}">
                                     <c:forTokens items="${feed.photoSaveFile }" delims="," var="photo">
                                       <img class="img_show_example" src="http://10.10.8.226:8888/sns/resources/images/FileRepo/${photo}">
                                     </c:forTokens>
                                  </c:if>
         ...
         <!-- ============================================== 타래 modal ================================================= -->
               <div class="ui tare long modal" class="scrolling" style="padding: 20px 0;"></div>
               <div class="ui write long modal" class="scrolling"></div>
                     
            </div>
         </div>
         <input type="hidden" id="getTotal" value="${total}"/>
         <input type="hidden" id="userInfo" value="${sessionScope.saveFile}"/>
      </div>
   </section>

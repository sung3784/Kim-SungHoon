                ...
                <div class="ui list">
	              	...
	              	<div class="item">
		                 <c:if test="${user.saveFile == null }">
		                   	<img class="profile my_button" id="img" src="http://localhost:8888/resources/images/defaultAvatar.png" onclick="fileUploadAction();">
		                 </c:if>
		                 <c:if test="${user.saveFile != null }">
			                   <img class="profile my_button" id="img" src=http://10.10.8.226:8888/sns/resources/images/FileRepo/${user.saveFile }" onclick="fileUploadAction();">
		                 </c:if>
	                </div>

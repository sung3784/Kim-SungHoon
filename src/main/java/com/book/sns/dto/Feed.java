...
public Feed(int feedNum, String content, String userId, String targetId, String[] viewTargetId, int targetFeedNum,
		...
		String saveFile, String profilePic, String photoSaveFile, int favoriteCheck) {
	super();
	...
	this.photoSaveFile = photoSaveFile;
...
public String getPhotoSaveFile() {
	return photoSaveFile;
}
public void setPhotoSaveFile(String photoSaveFile) {
	this.photoSaveFile = photoSaveFile;
}
...
public String toString() {
	return "Feed [feedNum=" + feedNum + ", content=" + content + ", userId=" + userId + ", targetId=" + targetId
			...
			+ likeCount + ", spreadCount=" + spreadCount + ", depth=" + depth + ", photoYN=" + photoYN + ", saveFile="
			+ saveFile + ", profilePic=" + profilePic + ", photoSaveFile=" + photoSaveFile + ", favoriteCheck="
			+ favoriteCheck + "]";
}

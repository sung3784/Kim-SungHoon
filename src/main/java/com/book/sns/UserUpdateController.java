...
public class UserUpdateController {
	 ...
	 * 
	 * UUID uuid=UUID.randomUUID(); String saveName=
	 * uuid+"_"+uploadfile.getOriginalFilename(); File file=new
	 * File(UPLOADPATH,saveName); try { uploadfile.transferTo(file); } catch
